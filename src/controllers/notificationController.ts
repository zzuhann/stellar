...
export const subscribeNotification = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await db.collection('notification_subscriptions').doc(userId).set({
      subscription,
...
export const sendApprovalNotification = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const unsubscribeNotification = async (req: Request, res: Response): Promise<void> => {
  try {
