...
router.patch(
  '/:id/resubmit',
  authenticateToken,
  (req, res) => eventController.resubmitEvent(req, res)
);
...
router.get(
  ...
  authenticateToken,
  requireAdmin,
  (req, res) => eventController.getPendingEvents(req, res)
);
router.patch(
  '/:id/review',
  authenticateToken,
  requireAdmin,
  (req, res) => eventController.reviewEvent(req, res)
);
router.put(
  '/:id/approve',
  authenticateToken,
  requireAdmin,
  (req, res) => eventController.approveEvent(req, res)
);
router.put(
  '/:id/reject',
  authenticateToken,
  requireAdmin,
  (req, res) => eventController.rejectEvent(req, res)
);
router.post(
  '/batch-review',
  authenticateToken,
